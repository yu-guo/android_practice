package com.guoyu.theme_style.uitis;
...
import com.guoyu.theme_style.App;
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && App.getApp().getExternalCacheDir() != null)
                sDefaultDir = App.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = App.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
